...
var API = {
    ...
    'API_LIST': {  //api接口列表
        ...
        'GOLD_COMPETECARD_REWARDLOG':'gold/CompeteCard/reward_log', //神马卡牌奖励卡领取记录
        'GOLD_COMPETECARD_FREEREWARD':'gold/CompeteCard/free_reward', //免费领取神马卡牌奖励卡
        'GOLD_COMPETECARD_REWARD':'gold/CompeteCard/reward', //神马卡牌奖励卡信息
        'GOLD_COMPETECARD_ADDREWARDORDER':'gold/CompeteCard/addRewardOrder', //生成神马卡牌奖励卡订单
        'GOLD_COMPETECARD_ORDERREWARD':'gold/CompeteCard/order_reward', //领取奖励卡
        'GOLD_COMPETECARD_USERREWARD':'gold/CompeteCard/user_reward',//神马卡牌奖励卡领取记录
        //***********************神马卡牌over************************************//
        //挑战最低价获奖列表
        ...
        'GOLD_INDEX_CHANNELSUB':'/Gold/Index/channelSub',//生活优选

        //***********************神马嘀嘀2.4.1over************************************//

        //***********************喵喵在途************************************//
        'MMONLINE_GETNOTEDETAIL':'/Mmonline/Article/getNoteDetail',//文章（社区）详情
        'MMONLINE_RE_DETAILCONTENT':'/mmonline/api/re/doDetailContent',//java文章（社区）详情
        'MMONLINE_DOLIKEARTICLE':'/Mmonline/Article/doLikeArticle',//文章（社区）点赞和取消点赞
        'MMONLINE_DOLIKENOTECOMMENT':'/Mmonline/Article/doLikeNoteComment',//文章（社区）评论点赞和取消点赞
        'MMONLINE_DOCOLLECTARTICLE':'/Mmonline/Article/doCollectArticle',//文章（社区）收藏和取消收藏
        'MMONLINE_ADDNOTECOMMENT':'/Mmonline/Article/addNoteComment',//文章（社区）添加评论
        'MMONLINE_FEEDCOMMENT':'/Mmonline/Article/feedComment',//文章（社区）回复评论
        'MMONLINE_GETFEEDCOMMENT':'/Mmonline/Article/getfeedComment',//文章（社区）评论回复列表
        //***********************喵喵在途over************************************//

        //***********************天荣汽配城************************************//
        'GOLD_PUR_APPLICATIONIN':'/Gold/Pur/applicationIn',//申请入驻
        'GOLD_PUR_ABOUTUS':'/Gold/Pur/aboutUs',//关于我们_产品介绍_联系我们
        //***********************天荣汽配城over************************************//

        //***********************神马汇v3.0************************************//
        'GOLD_PUR_STORELIST':'/gold/purchase/storeList',//供应商 商品列表
        'GOLD_PURCHASE_PRODUCTDETAIL':'/gold/purchase/productDetail',//申请入驻
        //***********************神马汇v3.0 over************************************//
        //***********************神马嘀嘀2.4.3************************************//
        'GOLD_VOTE_LIST':'/Gold/Vote/getVoteList',//投票主页
        'GOLD_VOTE_PUTVOTE':'/Gold/Vote/putVote',//嘉年华投票
        'GOLD_VOTE_VOTESHARE':'/Gold/Vote/getVoteShare',//为TA拉票
        'GOLD_VOTE_CHANGEIMG':'Gold/Vote/changeImage',//嘉年华投票图片上传
        'GOLD_PLAY_TEAMINTRODUCE':'/Gold/Play/teamIntroduce',//车队介绍
        'GOLD_PLAY_ADDINTRODUCE':'/Gold/Play/addIntroduce', // 编辑发布车队介绍
        //***********************神马嘀嘀2.4.3 over************************************//
        //***********************萌宝酷爸投票评选活动************************************//
        'GOLD_WXAPPVOTE_ACTIVITYPRO':'/Gold/WxappVote/activityPro',//活动首页人气排行榜
        'GOLD_WXAPPVOTE_PERSONAL':'/Gold/WxappVote/personal',//个人主页
        'GOLD_WXAPPVOTE_ACTIVITYINDEX':'/Gold/WxappVote/activityIndex',//活动首页圈内达人
        'GOLD_WXAPPVOTE_VOTE':'/Gold/WxappVote/vote',//投票
        'GOLD_WXAPPVOTE_SEARCH':'/Gold/WxappVote/search',//搜索
        'GOLD_WXAPPVOTE_ENLIST':'/Gold/WxappVote/enlist',//立即报名
        'GOLD_WXAPPVOTE_SHARE':'/Gold/WxappVote/share',//注册分享
        //***********************萌宝酷爸投票评选活动 over************************************//
    }
};
