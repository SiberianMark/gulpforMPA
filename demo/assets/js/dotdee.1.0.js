...
function downloadApp(node){
	...
	downloadTml+='<div class="app-download">'
        		...
        		+'<div class="down_detail down_btn">'
        		+'</div>'
						+'<img src="/web/assets/image/down_clos_ico.png" alt="" class="close_apps vc">'
		        // +'<div class="down_btn vc">立即打开</div>'
    			+'</div>';
	...
	$('.app-download .close_apps').on(func,function(){
        share_ornot=1;
