...
document.writeln("<script src='/web/car-service/assets/js/config.js?v=" + VERSION + "'><\/script>");
/*全项目统一使用的内部部js库*/
...
/*本项目公用js文件*/
document.writeln("<script src='/web/car-service/assets/js/goto.js?v=" + VERSION + "'><\/script>");
document.writeln("<script src='/web/car-service/assets/js/dotdee-car.js?v=" + VERSION + "'><\/script>");
document.writeln("<script src='/web/car-service/assets/js/share-bar-compent.js?v=" + VERSION + "'><\/script>");
/*本项目公用css文件*/
document.writeln('<link rel="stylesheet" type="text/css" href="/web/car-service/assets/css/dotdee-car.css?v=' + VERSION + '">');
(function(){
	//By 何变
