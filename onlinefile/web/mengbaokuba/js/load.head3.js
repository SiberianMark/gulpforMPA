...
document.writeln("<script src='/web/mengbaokuba/js/common.js?v=" + VERSION + "'><\/script>");
...
document.writeln('<link rel="stylesheet" type="text/css" href="/web/mengbaokuba/css/dotdee.1.0.css?v=' + VERSION + '">');
