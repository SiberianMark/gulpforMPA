...
document.writeln("<script src='/web/ddshop/assets/js/config.js?v=" + VERSION + "'><\/script>");
/*全项目统一使用的内部部js库*/
...
/*本项目公用js文件*/
document.writeln("<script src='/web/ddshop/assets/js/goto.js?v=" + VERSION + "'><\/script>");
document.writeln("<script src='/web/ddshop/assets/js/comm.js?v=" + VERSION + "'><\/script>");
/*本项目公用css文件*/
document.writeln('<link rel="stylesheet" type="text/css" href="/web/ddshop/assets/css/comm.css?v=' + VERSION + '">');
document.writeln('<link rel="stylesheet" type="text/css" href="/web/ddshop/assets/css/loading.min.css?v=' + VERSION + '">');
(function(){
	//By 何变
